...
/// Standalone screen for browsing expenses in a group. Reuses [ExpenseListView]
/// so the same content can be embedded as a tab in the group detail.
class ExpenseListScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      ...
      body: ExpenseListView(groupId: groupId),
...
/// Body-only widget for showing a group's expenses. Used directly as the
/// Expenses tab inside GroupDetailScreen so the user doesn't have to tap a
/// "View Expenses" card to see the list.
...
class _ExpenseCard extends StatelessWidget {
  ...
  const _ExpenseCard(
      {required this.expense, required this.isPayer, required this.onTap});
